...
bg_img = pygame.transform.scale(bg_img, (int(bg_img.get_width()//2), int(bg_img.get_height()//2)))
cloud1_img = pygame.image.load('background/cloud1.png').convert_alpha()
cloud1_img = pygame.transform.scale(cloud1_img, (int(cloud1_img.get_width()*3), int(cloud1_img.get_height()*3)))
cloud2_img = pygame.image.load('background/cloud2.png').convert_alpha()
cloud2_img = pygame.transform.scale(cloud2_img, (int(cloud2_img.get_width()*3), int(cloud2_img.get_height()*3)))
cloud3_img = pygame.image.load('background/cloud3.png').convert_alpha()
cloud3_img = pygame.transform.scale(cloud3_img, (int(cloud3_img.get_width()*3), int(cloud3_img.get_height()*3)))
...
def draw_bg():
    ...
    for x in range(4):
        ...
        screen.blit(cloud1_img, ((x * width) - scroll*0.6, SCREEN_HEIGHT - cloud1_img.get_height()+100))
        screen.blit(cloud2_img, ((x * width) - scroll*0.6, SCREEN_HEIGHT - cloud2_img.get_height()+100))
